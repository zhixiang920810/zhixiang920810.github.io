...
layui.define('form', function(exports){
	...
	function getCheckBoxs(options){
		...
		var boxs = '';
		// boxs +='<div class="layui-form-item" style="margin-left:15px;">' +
		...
		for(var area in regionList){
			...
			for(var province in regionList[area]){
				...
				||province=='香港'||province=='澳门'||province=='台湾'){
					boxs +='<input type="checkbox" name="' + name + '" value="' + province + '" title="' + province + '" lay-skin="' + skin + '" lay-filter="regionCheckBox-' + id + '">';
				}else{
					boxs +='<input type="checkbox" name="' + name + '" value="' + province + '" title="' + province + '" lay-skin="' + skin + '" lay-filter="regionCheckBox-' + id + '" disabled="disabled">';
				}
