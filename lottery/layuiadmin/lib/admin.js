...
layui.define("view", function (e) {
 var a = layui.jquery,
     ...
     P = {
      ...
      escape: function (e) {
       ...
       var i, t = e.seconds,
           n = a(e.elem),
           l = function (a) {
            t--, t < 0 ? (n.removeClass(f)
                .html("获取验证码"), t = e.seconds, clearInterval(i)) : n.addClass(f)
                .html(t + "秒后重获"), a || (i = setInterval(function () {
             l(!0)
            }, 1e3))
           };
       ...
       var i = u,
           t = a("#" + h),
           l = P.screen();
       "spread" === e ? (t.removeClass(x)
           .addClass(g), l < 2 ? i.addClass(v) : i.removeClass(v), i.removeClass(C)) : (t.removeClass(g)
           .addClass(x), l < 2 ? i.removeClass(C) : i.addClass(C), i.removeClass(v)), layui.event.call(this, n.MOD_NAME, "side({*})", {
        status: e
       })
      }, popup: l.popup,
      popupRight: function (e) {
       ...
       a = a || {}, P.tabsBody(e)
           .addClass(d)
           .siblings()
           .removeClass(d), F.rollPage("auto", e), layui.event.call(this, n.MOD_NAME, "tabsPage({*})", {
        url: a.url,
        text: a.text
       })
      }, resize: function (e) {
     ...
     F = P.events = {
      flexible: function (e) {
       ...
       var t = P.tabsBody(P.tabsPage.index)
           .find(e);
       ...
       var a = P.screen() < 2,
           i = layui.data(n.tableName)
               .note;
       F.note.index = P.popup({
        title: "便签",
        shade: 0,
        offset: ["41px", a ? null : e.offset()
            .left - 250 + "px"],
        anim: -1,
        id: "LAY_adminNote",
       ...
       var a = "layui-icon-screen-full",
           ...
           t = e.children("i");
       t.hasClass(a) ? (P.fullScreen(), t.addClass(i)
           .removeClass(a)) : (P.exitScreen(), t.addClass(a)
           .removeClass(i))
      }, about: function () {
       P.popupRight({
       ...
       var a = e.data("index");
       e.siblings(".layui-this")
           .data("index");
       e.hasClass(y) || (e.addClass(y)
           .siblings(".layui-this")
           .removeClass(y), P.initTheme(a))
       ...
       "all" === e ? (a(z + ":gt(0)")
           ...
           .trigger("click")) : (a(z)
           .each(function (e, t) {
            e && e != P.tabsPage.index && (a(t)
                .addClass(i), P.tabsBody(e)
                .addClass(i))
           }), a("." + i)
           .remove())
 ...
 ! function () {
  ...
  e.theme ? P.theme(e.theme) : n.theme && P.initTheme(n.theme.initColorIndex), "pageTabs" in layui.setter || (layui.setter.pageTabs = !0), n.pageTabs || (a("#LAY_app_tabs")
      .addClass(c), u.addClass("layadmin-tabspage-none")), s.ie && s.ie < 10 && l.error("IE" + s.ie + "下访问可能不佳，推荐使用：Chrome / Firefox / Edge 等高级浏览器", {
   offset: "auto",
   id: "LAY_errorIE"
  })
  ...
  n.find("." + y)
      .removeClass(y), P.screen() < 2 && P.sideFlexible(), s(n.children("li"))
 ...
 o.on("click", z, function () {
  ...
  e.index && P.tabsBody(e.index)
      .remove(), A(i), P.delResize()
  ...
  n.index.openTabsPage(i, t || e.text())  // layuiadmin的菜单模块用的
//  parent.menuItem(i, t || e.text(),Math.random());//情报系统使用的
  ...
  var e = a(this);
  if (!e.parent()
          .hasClass("layui-nav-item") || u.hasClass(C)) {
